#This version takes a file in the same directory as the program. Meant to make this exportable as an .exe file.
...
try:
    file_loc = input("""Put the file you want to convert in same folder as this executable file. \n Please enter the name of the Excel file, with the .xlsx at the end: """)
    new_file = input("Please enter the name of the converted file, with the .xlsx at the end: ")
    wb_obj = openpyxl.load_workbook(file_loc)
    sheet_obj = wb_obj.active
